...
finRes is still in the alpha stage of development; bugs have to be fixed and some design flaws must be addressed in some of the packages. The next stage of development will focus on fixing these issues before each individual package as well as the suite itself is submitted to the Comprehensive R Archive Network (CRAN) for public dissemination. 
