...
### Visualization
The bottom-end of the pipeline (communication) is adressed in the [plotit](https://bautheac.github.io/plotit/) package that provides a number of plot methods for finRes objects.   
