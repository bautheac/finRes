...
```
###### aggregate
In contrast, the aggregate open interest factor [@basu_financiallization_2020] is concerned with liquidity over the whole futures term structure and sorts on open interest aggregated (summed up) over the futures term structure:
