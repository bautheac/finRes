...
```
###### __aggregate__
In contrast, the aggregate open interest factor [@basu_financialisation_2020] is concerned with liquidity over the whole futures term structure and sorts on open interest aggregated (summed up) over the futures term structure:
