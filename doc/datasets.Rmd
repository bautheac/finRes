...
## BBGsymbols
The [BBGsymbols](https://bautheac.github.io/BBGsymbols/) package plays a critical role in finRes where it provides both the [pullit](https://bautheac.github.io/pullit/) and the [storethat](https://bautheac.github.io/storethat/) packages with support for interacting with Bloomberg through the [Rblpapi](https://github.com/Rblp/Rblpapi) interface [@Armstrong_Rblpapi_2018].
...
## GICS
[GICS](https://bautheac.github.io/GICS/) packages the Global Industry Classification Standard (GICS) dataset for consumption in R. Beyond its self-contained consumption value GICS belongs to finRes where, along with BBGsymbols and fewISOs, it helps with data wrangling and exploration.
```{r `GICS load`}
library(GICS)
