...
```{r `globals`, warnings = F, message = F, eval = T}
...
```{r `fund market storethat`, echo = F, eval = T}
fund_tickers <- c("SPY US Equity", "GLD US Equity", "EEM US Equity")
...
```{r `plot term structure`, fig.width = 7.5, fig.height = 5.5, fig.fullwidth = T, eval = T}
library(plotit)
...
```{r `plot performance`, fig.width = 7.5, fig.height = 6.5, fig.fullwidth = T, eval = T}
